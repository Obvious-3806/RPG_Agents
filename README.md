...
**Tracker** - typical tracker of present characters, clothes, inventory, quests, open threads, etc.. I find with good models this only needs to run once every 50-100 messages. I do not run a turn-by-turn tracker.
